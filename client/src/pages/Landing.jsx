...
import logo from '../pages/EdunirixLogo(1).png';
import {
  Calendar,
  Sparkles,
  TrendingUp,
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-xl">
                <img src={logo} alt="Edunirix Logo" className="w-8 h-8" />
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary-500/25"
              >
                Get Started
              </button>
            </div>
...
>
  ...
  <span
    className={`bg-clip-text text-transparent animate-pulse ${
      darkMode
        ? 'bg-gradient-to-r from-accent-500 to-accent-400 drop-shadow-[0_0_10px_rgba(255,215,0,0.6)]'
        : 'bg-gradient-to-r from-primary-500 to-secondary-500 drop-shadow-lg'
    }`}
    style={{ animationDuration: '3s' }} // 👈 slows down the pulse
  >
    Next-Gen Timetabling for Multidisciplinary Education
  </span>
</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              onClick={() => window.location.href = '/login'}
              className="group px-8 py-4 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary-500/25 flex items-center justify-center"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h3 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-success-500 to-success-600 bg-clip-text text-transparent">
          ...
          <div className={`p-8 rounded-2xl backdrop-blur-sm border ${
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-success-500 to-success-600 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-success-500/25"
              >
                Send Feedback
              </button>
            </div>
          ...
          <div className={`w-full max-w-md p-8 rounded-2xl border ${
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary-500/25"
              >
                Sign In
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="p-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl">
                <img src={logo} alt="Edunirix Logo" className="w-6 h-6" />
              </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-end space-y-4 md:space-y-0 md:space-x-6">
              <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                © 2025 EDUNIRIX. All rights reserved.
              </p>
